...
const skysparkPlugin = async () =>
  await import(/* webpackChunkName: "skysparkPlugin" */ 'app/plugins/datasource/skyspark/module');
...
const builtInPlugins: any = {
  ...
  'app/plugins/datasource/skyspark/module': skysparkPlugin,
