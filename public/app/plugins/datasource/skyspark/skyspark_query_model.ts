...
import { SkysparkQuery, SkysparkQueryTag } from './types';
import { ScopedVars } from '@grafana/data';
import { TemplateSrv } from 'app/features/templating/template_srv';

export default class SkysparkQueryModel {
  target: SkysparkQuery;
  selectModels: any[];
  queryBuilder: any;
  groupByParts: any;
  templateSrv: any;
  ...
  /** @ngInject */
  constructor(target: SkysparkQuery, templateSrv?: TemplateSrv, scopedVars?: ScopedVars) {
    this.target = target;
  ...
  private renderTagCondition(tag: SkysparkQueryTag, index: number, interpolate: boolean) {
    let str = '';
