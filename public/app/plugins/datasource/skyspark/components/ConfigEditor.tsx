...
import { SkysparkOptions, SkysparkSecureJsonData } from '../types';
...
export type Props = DataSourcePluginOptionsEditorProps<SkysparkOptions>;
...
export class ConfigEditor extends PureComponent<Props> {
  ...
  render() {
    ...
    const secureJsonData = (options.secureJsonData || {}) as SkysparkSecureJsonData;
    return (
      <>
        ...
        <h3 className="page-heading">SkysparkDB Details</h3>
        <div className="gf-form-group">
          ...
          <div className="gf-form-inline">
            <div className="gf-form">
              <FormLabel
                className="width-10"
                tooltip="You can use either GET or POST HTTP method to query your SkysparkDB database. The POST
        ...
        <div className="gf-form-group">
          <div className="grafana-info-box">
            ...
            <p>
              Setting the database for this datasource does not deny access to other databases. The SkysparkDB query
              ...
              <br />
              <br />
              To support data isolation and security, make sure appropriate permissions are configured in SkysparkDB.
            </p>
          </div>
        </div>
        <div className="gf-form-group">
