...
describe('SkysparkDBQueryCtrl', () => {
  const ctx = {} as any;

  beforeEach(() => {
    SkysparkQueryCtrl.prototype.datasource = {
      metricFindQuery: () => Promise.resolve([]),
    };
    SkysparkQueryCtrl.prototype.target = { target: {} };
    SkysparkQueryCtrl.prototype.panelCtrl = {
      panel: {
        targets: [SkysparkQueryCtrl.prototype.target],
      },
      refresh: () => {},
    };

    ctx.ctrl = new SkysparkQueryCtrl(
      {},
      {} as any,
      {} as any,
      {} as any,
