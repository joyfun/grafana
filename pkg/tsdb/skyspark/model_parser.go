...
type SkysparkdbQueryParser struct{}

func (qp *SkysparkdbQueryParser) Parse(model *simplejson.Json, dsInfo *models.DataSource) (*Query, error) {
...
func (qp *SkysparkdbQueryParser) parseSelects(model *simplejson.Json) ([]*Select, error) {
	var result []*Select
...
func (*SkysparkdbQueryParser) parseTags(model *simplejson.Json) ([]*Tag, error) {
	var result []*Tag
...
func (*SkysparkdbQueryParser) parseQueryPart(model *simplejson.Json) (*QueryPart, error) {
...
func (qp *SkysparkdbQueryParser) parseGroupBy(model *simplejson.Json) ([]*QueryPart, error) {
